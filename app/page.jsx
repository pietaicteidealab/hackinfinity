...
import { Calendar, Clock, Code, Cpu, Globe, Lightbulb, MapPin, Medal, Rocket, Trophy, Users } from "lucide-react"
        ...
        <div className="relative z-10 max-w-6xl mx-auto">
          <div className="flex flex-col md:flex-row items-center gap-12">
            <div className="md:w-1/2">
              <h2 className="text-3xl md:text-4xl font-bold mb-6 text-transparent bg-clip-text bg-gradient-to-r from-red-500 to-amber-500">
                HACKATHON THEMES
              </h2>
              <p className="text-gray-300 mb-6">
                This year's hackathon focuses on pushing the boundaries of what's possible. We've identified key areas
                where technology can make a significant impact. Choose one or combine multiple themes for your project.
              </p>
              <ul className="space-y-4">
                <li className="flex items-start gap-3 group">
                  <div className="mt-1 w-6 h-6 rounded-full bg-red-500/20 flex items-center justify-center flex-shrink-0 group-hover:bg-red-500/40 transition-colors duration-300">
                  ...
                  <div>
                    ...
                    <p className="text-gray-400 text-sm">Develop AI solutions that solve real-world problems</p>
                  </div>
                </li>
                <li className="flex items-start gap-3 group">
                  <div className="mt-1 w-6 h-6 rounded-full bg-amber-500/20 flex items-center justify-center flex-shrink-0 group-hover:bg-amber-500/40 transition-colors duration-300">
                  ...
                  <div>
                    ...
                    <p className="text-gray-400 text-sm">
                      Build decentralized applications that redefine digital ownership
                    </p>
                  </div>
                </li>
                <li className="flex items-start gap-3 group">
                  ...
                  <div>
                    ...
                    <p className="text-gray-400 text-sm">Create solutions that address environmental challenges</p>
                  </div>
                </li>
                <li className="flex items-start gap-3 group">
                  <div className="mt-1 w-6 h-6 rounded-full bg-amber-500/20 flex items-center justify-center flex-shrink-0 group-hover:bg-amber-500/40 transition-colors duration-300">
                  ...
                  <div>
                    ...
                    <p className="text-gray-400 text-sm">Surprise us with your creativity in any tech domain</p>
                  </div>
                </li>
              </ul>
            </div>
            <div className="md:w-1/2 relative">
              <div className="relative w-full h-[400px] rounded-lg overflow-hidden border border-gray-800 hover:border-red-500/50 transition-all duration-500 transform hover:scale-[1.02]">
                <div className="absolute inset-0 bg-gradient-to-br from-red-500/10 via-amber-500/10 to-red-500/10"></div>
                <div className="absolute inset-0 flex items-center justify-center">
                  <div className="w-64 h-64 relative">
                    <div className="absolute inset-0 bg-gradient-to-r from-red-500 to-amber-500 rounded-full blur-3xl opacity-20 animate-pulse"></div>
                    <div className="absolute inset-0 flex items-center justify-center">
                      <Code className="w-24 h-24 text-amber-400" />
                    </div>
                  </div>
                </div>
                <div className="absolute bottom-0 left-0 right-0 p-6">
                  <div className="flex items-center gap-2 mb-2">
                    ...
                    <p className="text-xs font-mono text-red-500">INNOVATION AWAITS</p>
                  </div>
                  <p className="font-mono text-amber-400 text-sm">
                    "The only limit to innovation is your imagination."
                  </p>
                </div>
              </div>
              <div className="absolute -bottom-4 -right-4 w-32 h-32 rounded-full border-4 border-red-500/30 animate-pulse"></div>
              <div className="absolute -top-4 -left-4 w-24 h-24 rounded-full border-2 border-amber-500/20"></div>
            </div>
          </div>
        </div>
      </section>
